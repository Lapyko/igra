...
namespace Сапёр
{
    public partial class Form1 : Form
    {
        ...
        void CheckWin(Button pressedButton)
        {
            ...
            if (button2.Text == button5.Text && pressedButton.Text == button8.Text && button8.Enabled == false)
            {
                MessageBox.Show("Победили " + pressedButton.Text);
                Application.Restart();
            }
        ...
        private void credictsToolStripMenuItem_Click(object sender, EventArgs e)
        {
            MessageBox.Show("Создатель: самый талантливый и быстропечатающий человек");
        }
    }
}
